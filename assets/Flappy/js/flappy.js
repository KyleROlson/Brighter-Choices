            ...
            function init() {
                ...
                manifest = [
                    {src:"assets/Flappy/img/bird.png", id:"bird"},
                    {src:"assets/Flappy/img/background.png", id:"background"},
                    {src:"assets/Flappy/img/ground.png", id:"ground"},
                    {src:"assets/Flappy/img/pipe.png", id:"pipe"},
                    {src:"assets/Flappy/img/restart.png", id:"start"},
                    {src:"assets/Flappy/img/share.png", id:"share"},
                    {src:"assets/Flappy/fonts/FB.svg"},
                    {src:"assets/Flappy/fonts/FB.ttf"}
                ];
            ...
            function goShare() {
                ...
                document.getElementById('comments').innerHTML = '<div class="card gedf-card"><div class="card-header"><div class="d-flex justify-content-between align-items-center"><div class="d-flex justify-content-between align-items-center"><div class="mr-2"><img class="rounded-circle" width="45" src="https://picsum.photos/50/50" alt=""></div><div class="ml-2"><div class="h5 m-0">SaraDoe</div></div></div><div></div></div></div><div class="card-body"><div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i>Just Now</div><p class="card-text">SaraDoe just scored ' + counter.text + ' points in Flappy Bird. Give it a shot?</p></div><div class="card-footer"><a href="#" class="card-link"><i class="fa fa-gittip"></i> Like</a><a href="#" class="card-link" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-comment"></i> Comment</a><a href="#" class="card-link"><i class="fa fa-mail-forward"></i> Share</a></div></div>' + document.getElementById('comments').innerHTML;
            }
